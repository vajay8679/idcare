...
<!--            <div class="block">
                ...
                <div class="block-section text-center">
                    ...
                    <p class="documents_p"><?php if (!empty($results->nda_doc)) {
                                    $a = explode("/", $results->nda_doc);
                                    echo $a[2];
                                } ?></p>
                </div>
                <div class="block-section text-center">
...
<?php } ?>
                ...
                <div class="block-section text-center">
                   <img src="<?php echo base_url() . 'backend_asset/images/Preloader_2.gif'; ?>" class="loaders-img" class="img-responsive">
                    <img src="<?php echo base_url() . 'backend_asset/images/document-management-big.png'; ?>" alt="avatar" class="img-responsive_document" style=" width: 70px; opacity: 0.5;"><br>
                    <p class="documents_p"><?php if (!empty($results->doc_file_referral)) {
    $a = explode("/", $results->doc_file_referral);
    echo $a[2];
} ?></p>
                </div>
                <div class="block-section text-center">
...
<?php } ?>
        ...
        <div class="col-md-12" >    <div class="block full">
                ...
                <form class="form-horizontal" role="form" id="editFormAjaxUser" method="post" action="<?php echo base_url('mdSteward/update') ?>" enctype="multipart/form-data">
