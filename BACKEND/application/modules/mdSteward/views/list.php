...
<!--                        <th class="text-center"><?php echo "Phone"; ?></th>-->
                ...
                <tbody>
                    <?php
                    if (isset($stawardsss) && !empty($stawardsss)):
                        

                        $rowCount = 0;
                        foreach ($stawardsss as $rows):
            ...
            <!--                                <td class="text-center"><?php
                                ...
                                <td class="actions text-center" >
                                    ...
                                    <!-- <a href="javascript:void(0)" data-toggle="tooltip" class="btn btn-default" onclick="editFn('vendors','vendor_edit','<?php echo encoding($rows->id); ?>');"><i class="fa fa-pencil"></i></a> -->
                                        <!-- <a href="<?php echo base_url() . 'mdSteward/edit?id=' . encoding($rows->id); ?>" data-toggle="tooltip" class="btn btn-default"><i class="fa fa-pencil"></i></a> -->
                                        ...
                                        <?php if ($this->ion_auth->is_admin() /* or $this->ion_auth->is_facilityManager() */) { ?>
                                            ...
                                            if ($rows->id != 1) {
                                                ...
                                                <?php } ?>
                                                <a href="javascript:void(0)" data-toggle="tooltip"   onclick="deleteFn('<?php echo USERS; ?>', 'id', '<?php echo encoding($rows->id); ?>', 'mdSteward', 'mdSteward/delVendors','<?php echo $rows->first_name . ' ' . $rows->last_name; ?>')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            <?php }
                                            ?>
...
<!--                        <th class="text-center"><?php echo "Phone"; ?></th>-->
                ...
                <tbody>
                    <?php
                    if (isset($staward) && !empty($staward)):
                        $care=json_decode($staward[0]->md_steward_id);

                        $rowCount = 0;
                        foreach ($care as $rows):
                           $this->db->select('*');
                            ...
                            <tr>
                                <td class="text-center text-primary"><strong><?php echo $rowCount; ?></strong></td>        
                                <!--                            <td><?php echo $rows->team_code; ?></td>-->
                                <td class="text-primary"><?php echo $row->first_name . ' ' . $row->last_name; ?></td>
