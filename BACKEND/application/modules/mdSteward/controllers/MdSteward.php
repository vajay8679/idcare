...
class MdSteward extends Common_Controller {

    public $data = array();
    public $file_data = "";
    public $_table = 'users';
    public $title = "MD Steward";
...
/*         $option = array('table' => USERS . ' as user',
            'select' => 'user.id,user.first_name,user.last_name,user.email,user.login_id,user.created_on,user.active,group.name as group_name,UP.doc_file',
            ...
            'where' => array('user.delete_status' => 0, 'group.id' => 3,'user.login_id' => $x),
    ...
    //         array('user_profile UP', 'UP.user_id=user.id', 'left')),
    //     'order' => array('user.id' => 'ASC'),
    //     'where' => array('user.delete_status' => 0, 'group.id' => 3),
    //     'order' => array('user.id' => 'desc')
    // );
            ...
            if ($this->filedata['status'] == 0) {
                ...
                if (empty($email_exist)) {
                    ...
                    $additional_data = array(
                        ...
                        'full_name' => ucwords($this->input->post('first_name') . ' ' . $this->input->post('last_name')),
                        //'team_code' => $code,
                        'login_id' => $x,
                        'username' => $code,
