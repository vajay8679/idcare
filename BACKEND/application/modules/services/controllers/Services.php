...
class Services extends Common_Controller { 
    public $data = array();
    public $file_data = "";
    public $_table = 'vendor_sale_services';
            ...
            if ($this->filedata['status'] == 0) {
               $response = array('status' => 0, 'message' => $this->filedata['error']);  
                ...
                if ($this->common_model->customInsert($option)) {
                    $response = array('status' => 1, 'message' => 'Successfuly Saved', 'url' => base_url('services'));
                }else {
        ...
        if ($this->form_validation->run() == FALSE):
            ...
            $response = array('status' => 0, 'message' => $messages);
                ...
                if ($this->filedata['status'] == 0) {
                    ...
                    $response = array('status' => 1, 'message' => lang('cms_success_update'), 'url' => base_url('services'));
              }  
