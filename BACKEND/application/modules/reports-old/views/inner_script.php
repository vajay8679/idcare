...
<script>
    ...
    function getAntibioticByCareUnit(careUnit,rx) {
        if(careUnit == ""){
        ...
        getDaysSavedByCareUnit(careUnit,rx);
        actual_dot_vs_new_dot_by_care_unit(careUnit,rx);
        actual_dot_vs_new_dot_by_care_unit_provider_doctor(careUnit,rx);
        getAntibioticByCareUnitSteward(careUnit,rx);
        actual_dot_vs_new_dot_by_care_unit_md_steward(careUnit,rx);
        get_rx_by_actual_dots(careUnit,rx);
        get_dx_by_actual_dots(careUnit,rx);
        getAntibioticByCareUnitProvider(careUnit,rx);
        getAntibioticByCareUnitProviderPrice(careUnit,rx);
        getAntibioticByCareUnitStewardPrice(careUnit,rx);
        getAntibioticByCareUnitProviderId();
        provider_md_rest();
    }
    ...
    function actual_dot_vs_new_dot_by_care_unit_provider_doctor(careUnit,rx) {
        ...
        $.ajax({
            method: "POST",
            url: url,
            data: {careUnit: careUnit, provider_doctor: provider_doctor,rx:rx},
            dataType: "json",
            success: function (response) {
                if (response.status == 200) {
                    var ChartGraphName = [];
    ...
    function get_dx_by_actual_dots(careUnit,rx) {
        var careUnit1 = $("#careUnit").val();
    ...
    function getAntibioticByCareUnitProviderId() {
        ...
        $.ajax({
            method: "POST",
            url: url,
            data: {careUnit: careUnit, provider: provider,rx:rx},
            dataType: "json",
            success: function (response) {
                if (response.status == 200) {
                    //console.log(response.antibiotic);
