...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url('testimonial/testimonial_add') ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                 <label class="col-md-3 control-label">Member Since</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control date-picker" name="member_since" id="member_since"/>
                                    </div>
                                     <span class="help-block m-b-none col-md-offset-3">
