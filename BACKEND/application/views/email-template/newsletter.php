        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            ...
            <tr>
                <td align="center" bgcolor="#9b59b6" style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
                    <img src="img/newsletter.png" alt="Newsletter Icon" width="200" height="200" style="display:block;" /><br/>
                    Newsletter #1
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 10px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px;">
                    <img src="img/image1.jpg" alt="Mountain Image" width="100%" style="display: block; height: auto;" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 10px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px;">
                    <img src="img/image2.jpg" alt="Office Image" width="100%" style="display: block; height: auto;" />
                </td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px; border-bottom: 1px solid #f6f6f6;">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 10px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px;">
                    <img src="img/image3.jpg" alt="Nature Image" width="100%" style="display: block; height: auto;" />
                </td>
            </tr>
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px; border-bottom: 1px solid #f6f6f6;">
                    ...
                    <table width="128" align="left" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="128" style="padding: 0 20px 20px 0;">
                                <img src="img/icon4.png" alt="Icon #4" width="128" height="128" style="display: block;" />
                            </td>
                        </tr>
                    </table>
                    <!--[if (gte mso 9)|(IE)]>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 20px 0 20px;">
                    <table width="128" align="left" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="128" style="padding: 0 20px 20px 0;">
                                <img src="img/icon5.png" alt="Icon #5" width="128" height="128" style="display: block;" />
                            </td>
                        </tr>
                    </table>
                    <!--[if (gte mso 9)|(IE)]>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 20px 0 20px; border-bottom: 1px solid #f6f6f6;">
                    <table width="128" align="left" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="128" style="padding: 0 20px 20px 0;">
                                <img src="img/icon6.png" alt="Icon #6" width="128" height="128" style="display: block;" />
                            </td>
                        </tr>
                    </table>
                    <!--[if (gte mso 9)|(IE)]>
                    ...
                    <table bgcolor="#9b59b6" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                        <tr>
                            <td align="center" height="50" style=" padding: 0 25px 0 25px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;" class="button">
                                <a href="#" style="color: #ffffff; text-align: center; text-decoration: none;">Show me more news</a>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td width="60%" style="color: #999999; font-family: Arial, sans-serif; font-size: 12px;">
                                <a href="#" style="color: #9b59b6;">Unsubscribe</a> from this newsletter
                            </td>
                            <td align="right" width="40%" style="color: #999999; font-family: Arial, sans-serif; font-size: 12px;">
                                2013-14 &copy; <a href="https://1.envato.market/x4R" style="color: #9b59b6;">ProUI</a>
                            </td>
                        </tr>
                    </table>
                </td>
