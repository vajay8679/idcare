                        ...
                        <tr>
                            <td align="left" style="padding:20px 5px; line-height:24px; color:#333;line-height: 26px;">
                                ...
                                Greetings for the Day<br><br>
                                   Hello!!! <?php echo $user; ?>, Thanks for registering with PLAYWINFANTASY.com.</p>
                             <p style="margin:0; padding:15px;">
                                   Your Login Username : <?php echo $email; ?></p>
                                  <p style="margin:0; padding:15px;">
                                   Your Login Password : <?php echo $password; ?> </p>

                                   <p style="margin:0; padding:15px;">
                                   Please login click on below url</p>
                                   <p style="margin:0; padding:15px;">
                                     <?php echo $base_url; ?> </p>

                                  <p style="margin:0; padding:15px;">
                                  Regards, PLAYWINFANTASY TEAM.</p> </td>
                        </tr>
<!--                        <tr>
