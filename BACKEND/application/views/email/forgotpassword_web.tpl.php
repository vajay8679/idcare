                        ...
                        <tr>
                            <td align="left" style="padding:20px 5px; line-height:24px; color:#333;line-height: 26px;">
                                ...
                                Hi <?php echo $user;?>,<br><br>
                                 Click on the button below to reset your password. This link will expire in 24 hours.     </p> </td>
                        
                        </tr>
                        <tr>
                                 <td align="left" style="padding:20px 5px; line-height:24px; color:#333;line-height: 26px;">
                                <p style="margin:0; padding:15px;">
                                   <?php echo sprintf(lang('email_forgot_password_subheading'), anchor('fantasy-reset-password/'. $forgotten_password_code, lang('email_forgot_password_link')));?></p> </td>
                        </tr>
<!--                        <tr>
                        ...
                        <tr>
                            <td>
                                <table style="background: #edf6ff;width: 100%;text-align: center;padding: 20px 0;">
                                    <tr>
                                        <td><img src="<?php echo base_url()?>Front-End/images/money.png"></td>
                                    </tr>
                                    <tr>
