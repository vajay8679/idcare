...
abstract class Abstract_Renderer {
  ...
  protected function _border_line($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $pattern_name, $r1, $r2) {
	...
	switch ($side) {
	case "top":
		$x += $width/2; $length -= $width; $y += $width/2;
		if ($r1 > 0)
			$this->_canvas->ellipse($x + $r1, $y + $r1, $r1, 0, 90-1, 45+2, $color, $width, $pattern);
      	$this->_canvas->line($x + $r1, $y, $x + $length - $r2, $y, $color, $width, $pattern);
		if ($r2 > 0)
			$this->_canvas->ellipse($x + $length - $r2, $y + $r2, $r2, 0, 45-1, 45+2, $color, $width, $pattern);
		break;
	case "bottom":
		$x += $width/2; $length -= $width; $y -= $width/2;
		if ($r1 > 0)
			$this->_canvas->ellipse($x + $r1, $y - $r1, $r1, 0, 225-1, 45+2, $color, $width, $pattern);
      	$this->_canvas->line($x + $r1, $y, $x + $length - $r2, $y, $color, $width, $pattern);
		if ($r2 > 0)
			$this->_canvas->ellipse($x + $length - $r2, $y - $r2, $r2, 0, 270-1, 45+2, $color, $width, $pattern);
	  break;
	case "left":
		$y += $width/2; $length -= $width; $x += $width/2;
		if ($r1 > 0)
			$this->_canvas->ellipse($x + $r1, $y + $r1, $r1, 0, 135-1, 45+2, $color, $width, $pattern);
      	$this->_canvas->line($x, $y + $r1, $x, $y + $length - $r2, $color, $width, $pattern);
		if ($r2 > 0)
			$this->_canvas->ellipse($x + $r2, $y + $length - $r2, $r2, 0, 180-1, 45+2, $color, $width, $pattern);
	  break;
	case "right":
		$y += $width/2; $length -= $width; $x -= $width/2;
		if ($r1 > 0)
			$this->_canvas->ellipse($x - $r1, $y + $r1, $r1, 0, 0-1, 45+2, $color, $width, $pattern);
      	$this->_canvas->line($x, $y + $r1, $x, $y + $length - $r2, $color, $width, $pattern);
		if ($r2 > 0)
			$this->_canvas->ellipse($x - $r2, $y + $length - $r2, $r2, 0, 315-1, 45+2, $color, $width, $pattern);
	  break;
	}
  }
  
  protected function _border_dotted($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
    $this->_border_line($x, $y, $length, $color, $widths, $side, $corner_style, "dotted", $r1, $r2);
  }

  
  protected function _border_dashed($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
    $this->_border_line($x, $y, $length, $color, $widths, $side, $corner_style, "dashed", $r1, $r2);
  }

  
  protected function _border_solid($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
  ...
  protected function _border_double($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
    list($top, $right, $bottom, $left) = $widths;
  ...
  protected function _border_groove($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
    list($top, $right, $bottom, $left) = $widths;
  ...
  protected function _border_ridge($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
    list($top, $right, $bottom, $left) = $widths;
  ...
  protected function _border_inset($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
    list($top, $right, $bottom, $left) = $widths;
  ...
  protected function _border_outset($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1, $r2) {
    list($top, $right, $bottom, $left) = $widths;
