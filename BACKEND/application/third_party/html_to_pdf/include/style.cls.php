...
class Style {
 ...
 /**#@+
  ...
  function get_border_top_left_radius() {
    return $this->length_in_pt($this->_props["border_top_left_radius"], 0);
  }
  
  function get_border_top_right_radius() {
    return $this->length_in_pt($this->_props["border_top_right_radius"], 0);
  }

  function get_border_bottom_left_radius() {
    return $this->length_in_pt($this->_props["border_bottom_left_radius"], 0);
  }

  function get_border_bottom_right_radius() {
    return $this->length_in_pt($this->_props["border_bottom_right_radius"], 0);
  }
  /**#@-*/
...
//@@@@@@@@@@@@@@@@@@@@@
  ...
  function _set_border_radii($val1, $val2, $val3, $val4) {
  ...
  function _set_border_radius_corner($val, $corner) {
    //see __set and __get, on all assignments clear cache!
    $this->_prop_cache["border_" . $corner . "_radius"] = null;
    $this->_props["border_" . $corner . "_radius"] = str_replace("none", "0px", $val);
  }
  /**#@-*/
