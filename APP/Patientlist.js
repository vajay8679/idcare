   ...
   //let arrAllData =  this.state.patientlistarray;
    ...
    EditPentry(id) {
      ...
      this.props.navigation.navigate('DignosisList', {
        patient_id: id,care_unit_id:this.props.navigation.getParam('care_unit_id')
...
//console.log(this.state.patientlistarray.length)
   if(this.state.patientlistarray )
   {
    ...
    data=  <FlatList
        ...
        <View style={{ width:'23%'}}>
    <Text style={{textAlign:'left',color:'#747474',fontSize:14}} >{item.patient_id}</Text>
       </View>
        <View style={{width:'50%',paddingLeft:2}}>
        <Text style={{textAlign:'left',color:'#747474',fontSize:14}} >{item.initial_dx_name}</Text>
        </View>
        <TouchableOpacity   onPress={this.EditPentry.bind(this,item.patient_id)} style={{ width:'26%'}} >
  ...
  return (
   ...
   <StatusBar barStyle='light-content' backgroundColor='#B22B57' ></StatusBar>  
    ...
    <Image style={{width:15,height:15,tintColor:'white',marginLeft:10}}  source={require('./image/back.png')} ></Image>
       ...
       <Text style={{fontWeight:'bold',color:'white',fontSize:15}}>Patients</Text>
       </View>
       ...
       <View style={{ height:37, opacity: 5,flexDirection:'row', borderWidth:0.5,borderColor:'#F7F7F7', backgroundColor:'white', width:'90%',alignItems:'center',alignSelf:'center',position: 'absolute',marginTop:70,zIndex:1,borderRadius:7}}>
    ...
    //  onSubmitEditing={() => this.password.focus()}
      ...
      <View style={{  borderTopRightRadius:10,borderBottomRightRadius:10}}>
        ...
        {/* <Icon style={{color:'#858585',height:50,paddingTop:10, backgroundColor:'white',borderRadius:10}} active name='search' /> */}
     ...
     {/* <View style={{flexDirection:'row',justifyContent:'space-around',backgroundColor:'#f7f7f7',marginTop:25, height:40,alignItems:'center'}}>
       ...
       <View style={{ width:'20%',paddingLeft:5}}>
        <Text style={{textAlign:'left',fontWeight:'900',color:'#747474',fontSize:15}} >ID</Text>
      </View>
